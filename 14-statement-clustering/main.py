...
def cluster(pixels, n_clusters=8):
	...
	n1 = 'parrots_' + str(n_clusters) + '.jpg'
	open(n1, 'a').close()
	imsave(n1, mean_image)
	...
	n2 = 'parrots_' + str(n_clusters) + '.jpg'
	open(n2, 'a').close()
	imsave(n2, median_image)
...
file_answer = open("img_answer.txt", "w")
